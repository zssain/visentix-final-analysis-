...
| AI-003 | **Governed — documented, not changed.** Accurate presence-proxy limitation note added to methodology (F-005/PGMS count presence, not quality; Phase-5 element-level upgrade = new formula version via spec-update). No formula touched. | `../../logs/archive/2026-08/INTELLIGENCE-QUALITY.md` | n/a | **DOCUMENTED** |
